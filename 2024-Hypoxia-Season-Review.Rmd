...
[Drought](https://www.nrcc.cornell.edu/regional/drought/drought.html) and windy conditions have developed across the region this Fall with October being the all-time driest on record for many climate locations across the watershed. Over 200 [wildland fires](https://portal.ct.gov/deep/forestry/forest-fire/fire-danger-weather-and-reporting) were reported in CT between September 1st and November 14th including the Hawthorne Fire on Lamentation Mountain in Berlin that burned over 100 acres and tragically claimed the life of a Wethersfield firefighter and another fire at Rocky Neck State Park that burned over 46 acres. Similar conditions were reported on Long Island including a major fire in Baiting Hollow (Riverhead) on 11/9. 
...
<div class = 'iplot'>
```{r, fig.cap = '<i>This interactive graph shows the maximum area of hypoxia in square miles (blue bars), duration of hypoxic conditions in days (black circles), and the five-year rolling average area in square miles (green line). </i>'}
